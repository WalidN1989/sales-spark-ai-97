...
export const APP_MODULES: AppModule[] = [
  ...
  { key: "reception", label: "Reception", path: "/app/reception", defaultRep: false },
  { key: "whatsapp", label: "WhatsApp", path: "/app/whatsapp", defaultRep: true },
  { key: "email", label: "Email", path: "/app/email", defaultRep: false },
  { key: "forecast", label: "Forecast", path: "/app/forecast", defaultRep: false },
