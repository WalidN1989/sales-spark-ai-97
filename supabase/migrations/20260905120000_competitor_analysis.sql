-- Competitor Analysis module: dated competitive research snapshots (append-only
-- history) linked to a competitor company/product and one of our product
-- categories. Feature matrix, strengths, weaknesses and gaps live in child
-- tables. Competitive intel is shared team knowledge, so RLS allows any
-- authenticated user to read/write; Edge Functions use the service role.
...
-- ---------- Seed: eTOP VMS vs GuestFlow (Endless Data) ----------
